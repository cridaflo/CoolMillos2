# qsys scripting (.tcl) file for niosII
package require -exact qsys 16.0

create_system {niosII}
...
add_connection clock_50.clk jtag.clk

add_connection clock_50.clk sys_pll.inclk_interface

add_connection clock_50.clk_reset Button_Pio.reset

add_connection clock_50.clk_reset IO_Pio.reset

add_connection clock_50.clk_reset LED_Pio.reset

add_connection clock_50.clk_reset Switch_Pio.reset

add_connection clock_50.clk_reset cpu.reset

add_connection clock_50.clk_reset epcs.reset

add_connection clock_50.clk_reset jtag.reset

add_connection clock_50.clk_reset ram_clk.clk_in_reset

add_connection clock_50.clk_reset sdram.reset

add_connection clock_50.clk_reset sys_clk.clk_in_reset

add_connection clock_50.clk_reset sys_clk_timer.reset

add_connection clock_50.clk_reset sys_id.reset

add_connection clock_50.clk_reset sys_pll.inclk_interface_reset

add_connection clock_50.clk_reset uart.reset

add_connection cpu.data_master Button_Pio.avalon_parallel_port_slave
...
add_connection cpu.data_master IO_Pio.avalon_parallel_port_slave
...
add_connection cpu.data_master LED_Pio.avalon_parallel_port_slave
...
add_connection cpu.data_master Switch_Pio.avalon_parallel_port_slave
...
add_connection cpu.data_master epcs.epcs_control_port
...
add_connection cpu.data_master jtag.avalon_jtag_slave
...
add_connection cpu.data_master sys_id.control_slave
...
add_connection cpu.data_master sys_pll.pll_slave
...
add_connection cpu.data_master uart.s1
...
add_connection cpu.debug_reset_request epcs.reset
...
add_connection cpu.instruction_master epcs.epcs_control_port
...
add_connection cpu.irq epcs.irq
set_connection_parameter_value cpu.irq/epcs.irq irqNumber {2}

add_connection cpu.irq jtag.irq
...
add_connection cpu.irq uart.irq
set_connection_parameter_value cpu.irq/uart.irq irqNumber {3}

add_connection sys_clk.clk Button_Pio.clk

add_connection sys_clk.clk IO_Pio.clk

add_connection sys_clk.clk LED_Pio.clk

add_connection sys_clk.clk Switch_Pio.clk

add_connection sys_clk.clk cpu.clk

add_connection sys_clk.clk sdram.clk

add_connection sys_clk.clk sys_clk_timer.clk

add_connection sys_clk.clk sys_id.clk

add_connection sys_clk.clk uart.clk

add_connection sys_pll.c0 epcs.clk

add_connection sys_pll.c0 sys_clk.clk_in

add_connection sys_pll.c1 ram_clk.clk_in
