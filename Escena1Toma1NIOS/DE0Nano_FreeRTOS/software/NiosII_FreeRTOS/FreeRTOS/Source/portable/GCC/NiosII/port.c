 ...
 * [Version]       1.00
 * [Author]        ea.rincon11@uniandes.edu.co
 * [Date]          24/07/2017
 * [Language]      'C'
 * [History]       1.20 - Edited from original file in http://www.alterawiki.com
 *
 */
//-----------------------------------------------------------------------
...
#define SYS_CLK_IRQ SYS_CLK_TIMER_N_IRQ
#define SYS_CLK_BASE SYS_CLK_TIMER_N_BASE
#define SYS_CLK_FREQ SYS_CLK_TIMER_N_FREQ
#define SYS_CLK_IRQ_INTERRUPT_CONTROLLER_ID SYS_CLK_TIMER_N_IRQ_INTERRUPT_CONTROLLER_ID
...
/*
 ** ===================================================================
 **     @brief Call back for the alarm function.
 **
 **     @param
 **
 */
...
/*
 ** ===================================================================
 **     @brief It is unlikely that the NIOS2 port will require
 **     this function as there is nothing to return to.
 **
 **     @param
 **
 */
...
/*
 ** ===================================================================
 **     @brief Setup the systick timer to generate the tick interrupts
...
void prvSetupTimerInterrupt(void) {
	...
	if (-EINVAL
			...
			SYS_CLK_IRQ, vPortSysTickHandler, 0x0,
					0x0))
#else
