...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../../../../../../../../../../DE0Nano_FreeRTOS.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4002090
SOPC_SYSID_FLAG += --sidp=0x4002090
ELF_PATCH_FLAG  += --sidp 0x4002090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1500903358
SOPC_SYSID_FLAG += --timestamp=1500903358
ELF_PATCH_FLAG  += --timestamp 1500903358
